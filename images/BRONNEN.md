...
`avengers-doomsday-still.jpg` — *krijgers van Wakanda schudden The Thing (Fantastic Four) de hand* — bron: https://www.filmdepot.nl/detail/34711/Avengers-Doomsday — film-ID 34711, media-ID 215035 — maker: Marvel Studios; distributie: The Walt Disney Company Netherlands — licentie: officieel Filmdepot-persmateriaal (geautoriseerd account Studio Bijlstra); credit staat als bijschrift op de pagina; onbewerkt — **voorwaarde: verwijderen zodra het materiaal uit het depot gaat; de wekelijkse ronde controleert dit** — toegevoegd: 19 augustus 2026 — **creditregel gecorrigeerd op 2 september 2026:** het bijschrift op de pagina noemde tot die dag CTMG (Columbia TriStar, de distributeur van Spider-Man: Brand New Day), overgenomen van de andere filmpagina en dus onjuist voor een Disney-titel. Nu: "© & ™ 2026 MARVEL. Distributie: The Walt Disney Company Benelux", allebei letterlijk uit het depot. Openstaand: het copyrightveld dat Filmdepot bij media-ID 215035 zelf meegeeft, staat niet op de detailpagina maar in de metadata-export; de eerstvolgende ronde met de depotroute leest die regel na en neemt hem letterlijk over, op deze site en op FilmPeil
